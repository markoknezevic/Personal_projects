...
public class HealthWidget extends Actor
{
    ...
    public HealthWidget()
    {
        progressBarStyle = new ProgressBar.ProgressBarStyle(
                Assets.__LIBGDX_FLATEARTH_SKIN__.newDrawable("white", Color.RED),
                Assets.__LIBGDX_FLATEARTH_SKIN__.newDrawable("white", Color.GREEN)
        );
        progressBarStyle.knobBefore = progressBarStyle.knob;
        healthBar = new ProgressBar(0, 100, 1, false, progressBarStyle);
        label = new Label("Health", Assets.__LIBGDX_FLATEARTH_SKIN__);
